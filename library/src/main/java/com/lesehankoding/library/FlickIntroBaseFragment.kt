...
/**
 * App intro base fragment
 *
 * @constructor Create empty App intro base fragment
 */
abstract class AppIntroBaseFragment : Fragment(), FlickIntroSlideSelectionListener,
    FlickIntroSlideBackgroundColorHolder {
    ...
    override fun onCreateView(
        ...
        val titleText = view.findViewById<TextView>(R.id.txtTitle)
        val descriptionText = view.findViewById<TextView>(R.id.txtDescription)
        val slideImage = view.findViewById<ImageView>(R.id.image)
        val mainLayout = view.findViewById<RelativeLayout>(R.id.main)
