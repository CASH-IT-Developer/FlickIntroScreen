...
import com.lesehankoding.library.FlickIntroViewPagerListener
import com.lesehankoding.library.internal.viewpager.ViewPagerTransformer
import kotlin.math.max

/**
 * Flick intro view pager
 *
 * @constructor
 *
 * @param context
 * @param attrs
 */
internal class FlickIntroViewPager(context: Context, attrs: AttributeSet) : ViewPager(context, attrs) {

    var isFullPagingEnabled = true
    var isPermissionSlide = false
    var onNextPageRequestedListener: FlickIntroViewPagerListener? = null
     ...
     * @param listener
     */
    internal fun addOnPageChangeListener(listener: FlickIntroBase.OnPageChangeListener) {
    ...
    /**
     * Override is required to trigger [FlickIntroBase.OnPageChangeListener.onPageSelected] for the first page.
...
//                }
    ...
    /**
     * Set app intro page transformer
     *
     * @param flickIntroTransformer
     */
    fun setAppIntroPageTransformer(flickIntroTransformer: FlickIntroAnimationType) {
        setPageTransformer(true, ViewPagerTransformer(flickIntroTransformer))
    }
